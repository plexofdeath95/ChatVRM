...
Command: npx gltfjsx@6.5.3 .\public\low_poly_room_3.glb --output src/model-components/LowPolyRoom3.tsx --types 
*/
...
export function LowPolyRoom(props: JSX.IntrinsicElements["group"]) {
  const { nodes, materials } = useGLTF("/low_poly_room_3.glb") as GLTFResult;
  return (
      ...
      <group rotation={[-Math.PI / 2, 0, 0]}>
        ...
        >
          ...
          <mesh
            ...
            material={materials["LowPoly.001"]}
            position={[0.25, -0.209, 0.502]}
            userData={{ selectable: true }}
            name="DRAWER3"
          />
          <group
            position={[0.21, 0.354, -0.138]}
            userData={{ selectable: true }}
            name="KEYBOARD"
          >
            <mesh
          ...
          >
            <mesh
              ...
              position={[0.019, 0.151, 0]}
            />
            <group position={[0.038, 0.407, 0.016]}>
              <mesh
          ...
          <mesh
            ...
            material={materials["LowPoly.001"]}
            position={[0.143, 0.337, 0.333]}
            userData={{ selectable: true }}
            name="MUG"
          />
          <group
            position={[0.054, -0.091, -0.792]}
            name="COMPUTER"
            userData={{ selectable: true }}
          >
            <mesh
          ...
          <mesh
            ...
            position={[-0.05, 0.544, 0.378]}
            rotation={[0, -Math.PI / 6, 0]}
            userData={{ selectable: true }}
          />
          <group
            position={[-0.05, 0.522, -0.71]}
            rotation={[0, -Math.PI / 6, 0]}
            userData={{ selectable: true }}
            name="SPEAKER_R"
          >
        ...
        >
          ...
          <mesh
            ...
            name="CHAIR"
          />
          <group position={[-2.575, 0.005, 0.434]} name="POWER_SOCKET">
            <mesh
          ...
          <group userData={{ selectable: true }} name="RUG">
            <mesh
              geometry={nodes.Rug.geometry}
              material={materials["LowPoly.001"]}
              position={[-1.972, 1.009, 0.0]}
            />
          </group>
        </mesh>
        <mesh
...
useGLTF.preload("/low_poly_room_3.glb");
